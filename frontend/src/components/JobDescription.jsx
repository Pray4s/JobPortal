    ...
    const applyJobHandler = async () => {
        try {
            ...
            if (res.data.success) {
                ...
                dispatch(setSingleJob(updatedSingleJob)); //helps us to understand real time UI update
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Salary : <span className='pl-4 font-normal text-gray-800'>{singleJob?.salary === 45000 ? '12' : singleJob?.salary} LPA</span></h1>
